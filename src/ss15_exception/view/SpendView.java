package ss15_exception.view;

import ss15_exception.controller.ISpendController;
import ss15_exception.controller.SpendController;
            ...
            do {
                ...
                for (Spend spend : spendList) {
                    if (spend.getId() == id) {
                        ...
                        throw new UniqueIDException("ID không tồn tại vui lòng nhập lại ");
                    }
                }
            } while (true);
        } catch (UniqueIDException e) {
